...
def read_published_coverage(workspace_root, dataset_name: str, layout=None) -> dict[str, Any] | None:
    ...
    manifest_path = _dataset_root(workspace_root, dataset_name, layout) / "manifest.yaml"
