...
2. Create `docs/datasets/{provider}/{api_name}/dataset_card.md`.
3. Create `docs/datasets/{provider}/{api_name}/schema.yaml`.
...
5. Add `docs/datasets/{provider}/{api_name}/maintenance.md` using
   `docs/datasets/__shared__/_general_maintenance_sop.md` as the checklist.
...
- Generated data is ignored or stored outside git, with the active published
  version living under `datasets/{provider}/{api_name}/published/current/`.
