"""Operations for mycompany/hello.
...
from mycompany.plugins.datasets.hello import SPEC, FIELDS
...
class HelloRuntime(DatasetRuntimeBase):
    """Dataset runtime for mycompany/hello.
    ...
    def operation_worker(
        ...
        *,
        ...
        return HelloWorker(workspace=workspace)
